...
@Tag(name = "Agent管理模块", description = "Agent对话相关接口 - 基于AgentScope HarnessAgent，支持同步和流式两种模式")
@RestController
...
public class AgentController {
    ...
    @Operation(
        summary = "Agent同步聊天",
        description = "使用HarnessAgent进行同步对话，支持工具调用、记忆管理、推理追踪。开启debugMode可返回完整思考链和工具调用记录",
    ...
    @Operation(
        ...
        description = "使用HarnessAgent进行SSE流式对话，实时返回响应内容。支持工具调用、记忆管理",
        operationId = "agentStreamChat"
    )
    @ApiResponses(value = {
        @ApiResponse(responseCode = "200", description = "流式响应",
            content = @Content(mediaType = "text/event-stream",
                examples = @ExampleObject(value = "data: {\"type\":\"start\",\"traceId\":\"trace-123\",\"success\":true}\n\ndata: {\"type\":\"content\",\"content\":\"你好！\",\"traceId\":\"trace-123\",\"success\":true}\n\ndata: {\"type\":\"end\",\"content\":\"\",\"traceId\":\"trace-123\",\"success\":true}")))
    })
